// Type: DLL_RFC.Manual.ManualProcessing
...
{
  internal class ManualProcessing
  {
    ...
    private float[] temp1 = new float[500];
    ...
    public float[][] RawData => this.rawData_float_ori;
    ...
    public ManualProcessing(InputParameters para)
    {
      this.para = para;
    ...
    public void GetDepthProfile(float[] floatData)
    {
      this.GetRawData(floatData);
      this.GetTopProfile();
    ...
    private void GetRawData(float[] floatData)
    {
      ...
      {
        Array.Copy((Array) floatData, index * 1500, (Array) this.rawData_float[index], 0, this.rawData_float[0].Length);
        Array.Copy((Array) floatData, index * 1500, (Array) this.rawData_float_ori[index], 0, this.rawData_float[0].Length);
      }
    }
